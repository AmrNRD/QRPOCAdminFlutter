import 'package:QRAdminFlutter/ui/common/custom_raised_button.dart';
import 'package:QRAdminFlutter/ui/common/form.input.dart';
...
class RestPasswordScreen extends StatefulWidget {
  ...
  const RestPasswordScreen({Key key,@required this.goToSignIn}) : super(key: key);
  @override
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Text("Forgot Password", style: Theme.of(context).textTheme.headline1.copyWith(fontSize: 25, fontWeight: FontWeight.bold)),


              SizedBox(height: AppDimens.marginEdgeCase24),

              //email
              FormInputField(title: "phone_number", focusNode: _emailFocusNode, onSave: (value) => _authData['phone'] = value, isRequired: true),


              CustomRaisedButton(label: AppLocalizations.of(context).translate("send"), onPress: onReset, isLoading: isLoading),
              SizedBox(height: 140),

              FlatButton(onPressed: widget.goToSignIn, child: Text(AppLocalizations.of(context).translate("back_to_login"), style: Theme.of(context).textTheme.subtitle1)),
